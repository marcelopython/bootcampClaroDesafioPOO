...
public class Bootcamp {
    ...
    // Polimorfismo exemplo o tipo e Set do HashSet
    private Set<Dev> devsInscritos = new HashSet<>(); // A order não importa
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); // os conteudos as orderns e importante
